...
<!-- Header -->
<div class="header">
  <a href="home.php" class="logo">Intelligent Tourist Guide</a>
...
if($result2->num_rows > 0){
	...
	echo "<center><h2  color=\"#ffffff\" style = \"font-size:26px;font-style:bold;\"><font color=\"white\">Tourist Guide APP</font></h2></center><br/>";
